...
$$
\frac{\part f(\textbf x)}{\part \textbf x} = \frac{\part f(x_1, x_2, ...,x_n)}{\part \textbf x} = 
\left( 
\begin{array}{c}
\frac{\part f(x_1, x_2, ...,x_n)}{\part x_1}\\
\frac{\part f(x_1, x_2, ...,x_n)}{\part x_2}\\ 
...\\ 
\frac{\part f(x_1, x_2, ...,x_n)}{\part x_n}\\
\end{array}
\right)
$$
...
$$
\frac{\part \textbf  f(\textbf x)}{\part \textbf x} =

\begin{pmatrix}
\frac{\part \textbf f(\textbf x)}{\part x_1}\\
\frac{\part \textbf f(\textbf x)}{\part x_2}\\ 
...\\ 
\frac{\part \textbf f(\textbf x)}{\part x_n}\\
\end{pmatrix} 
=

\begin{pmatrix}
\frac{\part f_1(\textbf x)}{\part x_1} & \frac{\part f_2(\textbf x)}{\part x_1} &
\frac{\part f_3(\textbf x)}{\part x_1} &... \frac{\part f_m(\textbf x)}{\part x_1}\\
\frac{\part f_1(\textbf x)}{\part x_2} & \frac{\part f_2(\textbf x)}{\part x_2} &
\frac{\part f_3(\textbf x)}{\part x_2} &... \frac{\part f_m(\textbf x)}{\part x_2}\\
...\\ 
\frac{\part f_1(\textbf x)}{\part x_n} & \frac{\part f_2(\textbf x)}{\part x_n} &
\frac{\part f_3(\textbf x)}{\part x_n} &... \frac{\part f_m(\textbf x)}{\part x_n}\\
\end{pmatrix}
$$
...
#### 1. $\frac{\part A\textbf x}{\part \textbf x} = \frac{\part \textbf x^T A^T}{\part \textbf x} = A^T$
...
其对 $\textbf x$ 的偏导数为
$$
\frac{\part \textbf  f(\textbf x)}{\part \textbf x} = \frac{\part A\textbf x}{\part \textbf x} = 
...
#### 2. $\frac{\part\textbf x^T A\textbf x}{\part \textbf x} = (A + A^T)\textbf x$
...
\frac{\part f(\textbf x)}{\part \textbf x} = \frac{\part\textbf x^T A\textbf x}{\part \textbf x}= \frac{\part f(x_1, x_2, ...,x_n)}{\part \textbf x} = 
\begin{pmatrix}
\frac{\part f(x_1, x_2, ...,x_n)}{\part x_1}\\
\frac{\part f(x_1, x_2, ...,x_n)}{\part x_2}\\ 
...\\ 
...
#### 3. $\frac{\part ||\textbf x||^2}{\part\textbf  x}  =2\textbf x$

$$
\frac{\part ||\textbf x||^2}{\part\textbf  x} = \frac{\part\textbf  x^T\textbf x}{\part \textbf x} =2\textbf x
$$
...
由上面可以简写梯度
$$
\nabla f(\textbf x) = \frac{\part f(\textbf x)}{\part \textbf x} = 
\begin{pmatrix}
\frac{\part  f(\textbf x)}{\part x_1}\\
\frac{\part  f(\textbf x)}{\part x_2}\\ 
...\\ 
\frac{\part f(\textbf x)}{\part x_n}\\
\end{pmatrix}
$$
...
$$
\frac {\part f(\mathbf {\hat w})}{\mathbf {\part \hat w}} = \frac {\part (\textbf y - X\mathbf {\hat w})^T(\textbf y - X\mathbf {\hat w})}{\mathbf {\part \hat w}} = \\\frac {\part \mathbf y^T \mathbf y}{\mathbf {\part \hat w}} - \frac {\part \mathbf y^T X\mathbf {\hat w}}{\mathbf {\part \hat w}} - \frac {\part \mathbf {\hat w} X\mathbf y^T}{\mathbf {\part \hat w}} + \frac {\part \mathbf {\hat w} X^TX\mathbf{\hat w}}{\mathbf {\part \hat w}} = 2X^T(X\mathbf {\hat w} - \textbf y)
$$
...
$$
\frac{\part J}{\part \textbf w} = \frac{1}{m}\sum_{i =1}^{m}(-y_i \textbf x_i + \frac{e^{\textbf w^T \textbf x_i + b}}{1 + e^{\textbf w^T \textbf x_i + b}} \textbf x_i) =\\

\frac{1}{m}\sum_{i =1}^{m}(f(\textbf x_i)-y_i) \textbf x_i\\

\frac{\part J}{\part  w_j} = \frac{1}{m}\sum_{i =1}^{m}(-y_i  x_{ij} + \frac{e^{\textbf w^T \textbf x_i + b}}{1 + e^{\textbf w^T \textbf x_i + b}}  x_{ij}) =\\
\frac{1}{m}\sum_{i =1}^{m}(f(\textbf x_i) - y_i)  x_{ij}\\

\frac{\part J}{\part  b} = \frac{1}{m}\sum_{i =1}^{m}(f(\textbf x_i) - y_i)
$$
...
分别求偏导求解。
$$
\frac {\part L}{\part \textbf w} = \textbf w - \sum_{i=1}^m\alpha_iy_i\textbf x_i \\
\frac {\part L}{\part b} = -\sum_{i=1}^m\alpha_iy_i
$$
令上述偏导数等于零解得
$$
